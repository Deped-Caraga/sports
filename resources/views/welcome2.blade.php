...
<body class="antialiased">
    ...
    <!-- Modal -->
    <div class="modal fade" data-backdrop="static" id="modal_login" tabindex="-1" role="dialog"
        aria-labelledby="modal_loginLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal_loginLabel">Login via Facebook or Google</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <a href="{{ url('auth/facebook') }}"><img class="img-fluid"
                                    src="{{ url('/images/fb_login.png') }}"></a>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <a href="{{ url('auth/google') }}">
                                <img class="img-fluid" src="{{ url('/images/google_login.png') }}"></a>
                        </div>
