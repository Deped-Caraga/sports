                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="justify-content-center">
                                <img style="width:100%" src="{{ url('/images/logo.png') }}" alt="">
                            </div><!-- End Logo -->
    ...
    <script>
        ...
        function login(){
            ...
            if(yourUsername!="" && yourPassword!=""){
                $.post(baseUrl + '/login_user',{'_token':_token,'yourUsername':yourUsername,'yourPassword':yourPassword},function(data){
                    if(data=='success'){
